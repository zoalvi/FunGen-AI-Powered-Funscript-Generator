...
class SegmentColors:
    ...
    HJ = (0.0, 0.7, 0.7, 0.7)
    NR = (0.5, 0.5, 0.5, 0.7)
    CG_MISS = (1.0, 0.6, 0.0, 0.7)
    REV_CG_DOG = (1.0, 0.8, 0.6, 0.7)
    CG = (1.0, 0.0, 0.0, 0.7)
    MISS = (1.0, 0.7, 0.0, 0.7)
    REV_CG = (1.0, 0.5, 0.5, 0.7)
    DOG = (0.6, 0.4, 0.2, 0.7)
    FOOTJ = (0.8, 0.6, 1.0, 0.7)
    BOOBJ = (1.0, 0.7, 0.8, 0.7)
    CLOSEUP = (0.9, 0.9, 0.9, 0.7)
    INTRO = (0.4, 0.8, 0.4, 0.7)
    OUTRO = (0.8, 0.4, 0.4, 0.7)
    TRANSITION = (0.7, 0.7, 0.7, 0.7)
